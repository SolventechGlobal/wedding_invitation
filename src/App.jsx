      ...
      <div className="relative inset-0 z-10 flex flex-col items-center">
        ...
        <ParallaxBanner className="w-full md:min-h-dvh m-0 hidden md:block">
          ...
          <ParallaxBannerLayer speed={30} style={{ zIndex: 0 }}>
            <img src="src/public/cielo.png" alt="Cielo" className="w-full mt-60"/>
          </ParallaxBannerLayer>

          <ParallaxBannerLayer speed={-5} style={{ zIndex: 1 }}>
            <img src="src/public/nubes.png" alt="Nubes" className="lg:mt-40 mt-35"/>
          </ParallaxBannerLayer>

          <ParallaxBannerLayer speed={-10} style={{ zIndex: 3 }}>
            <img src="src/public/marco_flores.png" alt="Marco Flores" className="mt-20"/>
          </ParallaxBannerLayer>

          <ParallaxBannerLayer speed={-20} style={{ zIndex: 1 }}>
            <img src="src/public/arboles_fondo.png" alt="Arboles" className="mt-30"/>
          </ParallaxBannerLayer>

          <ParallaxBannerLayer speed={-10} style={{ zIndex: 2 }}>
            <img src="src/public/bamboo.png" alt="Bamboo" className="lg:mt-15"/>
          </ParallaxBannerLayer>

          <ParallaxBannerLayer speed={5} style={{ zIndex: 3 }}>
            <img src="src/public/camino.png" alt="Casa" className="lg:mt-50 mt-20"/>
          </ParallaxBannerLayer>

          <ParallaxBannerLayer speed={5} style={{ zIndex: 3 }}>
            <img src="src/public/casa_pintada.png" alt="Casa" className="lg:mt-50 mt-20"/>
          </ParallaxBannerLayer>
        ...
        <div className="w-full min-h-fit m-0 md:hidden relative">
          <img src="src/public/casa_movil.png" alt="Casa Mobile" className="w-full h-70"/>
        ...
        <Parallax speed={5} style={{ zIndex: 3 }}>
          <img src="src/public/flores_transicion.png" 
        ...
        <img src="src/public/divider.png" alt="Divider" className="my-16"/>
        ...
        <img src="src/public/divider.png" alt="Divider"/>

        {/* Footer */}
        <div className="h-48 w-full m-0 sm:mt-15">
          <img src="src/public/flores_bottom.png" alt="Footer Decoration" className="w-full h-full object-cover hidden md:block" />
          <img src="src/public/flores_bottom.png" alt="Footer Decoration Mobile" className="w-fit h-full object-cover md:hidden" />
        </div>
      </div>
