...
const Countdown = ({ targetDate }) => {
    ...
    return (
        <div className="w-full h-fit flex flex-col items-center justify-center px-4 mt-10">
            ...
            {/* CARDS */}
            <Parallax speed={20}>
                <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 sm:gap-6 max-w-4xl w-full mb-10 px-6">
            ...
            <div className="text-center px-4">
                <h2 className="text-4xl tracking-widest text-[#6b6762] my-2 ">
                    CUENTA REGRESIVA
                </h2>
                <p className="text-lg text-[#8a867f]">
